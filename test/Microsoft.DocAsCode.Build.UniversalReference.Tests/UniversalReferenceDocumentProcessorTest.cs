...
public class UniversalReferenceDocumentProcessorTest : TestBase
{
    ...
    public void ProcessPythonModelShouldSucceed()
    {
        ...
        Assert.Equal("""
            <p sourcefile="TestData/yml/cntk.core.Value.yml" sourcestartlinenumber="1">shape of the value</p>
        ...
        Assert.Equal("""
            <p sourcefile="TestData/yml/cntk.core.Value.yml" sourcestartlinenumber="1">Creates a <xref href="cntk.core.Value" data-throw-if-not-resolved="False" data-raw-source="@cntk.core.Value" sourcefile="TestData/yml/cntk.core.Value.yml" sourcestartlinenumber="1"></xref> object.</p>

            """,
            firstChildrenValue.Summary);
        Assert.Equal("""
            <p sourcefile="TestData/yml/cntk.core.Value.yml" sourcestartlinenumber="1"><xref href="cntk.core.Value" data-throw-if-not-resolved="False" data-raw-source="@cntk.core.Value" sourcefile="TestData/yml/cntk.core.Value.yml" sourcestartlinenumber="1"></xref> object.</p>
    ...
    public void ApplyOverwriteDocumentForPythonShouldSucceed()
    {
        ...
        Assert.Equal("""
            ...
            """, model.Conceptual);
        Assert.Equal("""
            <p sourcefile="TestData/overwrite/cntk.core.Value.md" sourcestartlinenumber="1">summary of cntk.core.Value</p>
