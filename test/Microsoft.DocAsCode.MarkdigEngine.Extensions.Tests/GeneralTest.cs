...
public class GeneralTest
{
    ...
    public void TestDfm_EncodeInStrongEM()
    {
        ...
        var expected = """
            <p>tag started with non-alphabet should be encoded &lt;1-100&gt;, &lt;_hello&gt;, &lt;?world&gt;, &lt;1_2 href=&quot;good&quot;&gt;, &lt;1 att='bcd'&gt;.
    ...
    [InlineData(" https://github.com/dotnet/docfx/releases ", """
        <p><a href="https://github.com/dotnet/docfx/releases">https://github.com/dotnet/docfx/releases</a></p>
    ...
    [InlineData("Hot keys: <kbd>Ctrl+[</kbd> and <kbd>Ctrl+]</kbd>", """
        <p>Hot keys: <kbd>Ctrl+[</kbd> and <kbd>Ctrl+]</kbd></p>
...
""")]
    [InlineData("[name](xref:uid \"title\")", """
        <p><a href="xref:uid" title="title">name</a></p>

        """)]
    [InlineData("<xref:uid>text", """
        <p><xref href="uid" data-throw-if-not-resolved="True" data-raw-source="&lt;xref:uid&gt;"></xref>text</p>

        """)]
    [InlineData("<xref:'uid with space'>text", """
        <p><xref href="uid with space" data-throw-if-not-resolved="True" data-raw-source="&lt;xref:'uid with space'&gt;"></xref>text</p>
...
""")]
    ...
    public void TestDfmLink_LinkWithSpecialCharactersInTitle()
    {
        ...
        var expected = """
            <p><a href="https://www.google.com.sg/?gfe_rd=cr&amp;ei=Xk" title="Google's homepage">text's string</a></p>
    ...
    public void TestDfmLink_WithSpecialCharactersInTitle()
    {
        ...
        var expected = """
            <p><a href="girl.png" title="title is &quot;hello&quot; world.">This is link text with quotation ' and double quotation &quot;hello&quot; world</a></p>
    ...
    public void TestDfmTagValidate()
    {
        ...
        var source = """
            <div><i>x</i><EM>y</EM><h1>z<pre><code>a*b*c</code></pre></h1></div>
    ...
    public void TestPathUtility_AbsoluteLinkWithBracketAndBracket()
    {
        ...
        var expected = """
            <p><a href="http://msdn2.microsoft.com/library/73ctwf33(VS.90).aspx">User-Defined Date/Time Formats (Format Function)</a></p>
