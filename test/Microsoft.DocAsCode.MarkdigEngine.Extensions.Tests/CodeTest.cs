...
public class CodeTest
{
    ...
    static public string contentCSharp = """
        using System;
        ...
        """;
    static public string contentCSharp2 = """
        using System;
        ...
        """;
    static public string contentCSharpRegion = """
    ...
    static public string contentASPNet = """
        ...
        """;
    static public string contentVB = """
        '<Snippet1>
        ...
        """;
    static public string contentCPP = """
        //<Snippet1>
        ...
        // </snippet2>
        """;
    static public string contentCPP2 = """
        //<Snippet1>
        using namespace System;
        ...
        //</ Snippet1  >
        """;
    static public string contentCrazy = """
        //<Snippet1>
        using namespace System;
        ...
        // </snippet2>
        """;
    static public string contentSQL = """
        -- <everything>
        --<students>
        ...
        --</everything>
        """;
    static public string contentPython = """
        #<everything>
        #<first>
        ...
        """;
    static public string contentBatch = """
        REM <snippet>
        :Label1
        	:Label2
        :: Comment line 3
        ...
        """;
    static public string contentErlang = """
        -module(hello_world).
        -compile(export_all).
        ...
        % </snippet>
        """;
    static public string contentLisp = """
        ;<everything>
        ...
        ;</everything>
        """;
    static public string contentRuby = """
        ...
        """;
    static public string contentCSS = """
        body {
          padding-top: 70px;
        }
    ...
    [Theory]
    [InlineData(@":::code source=""source.cs"" range=""9"" language=""csharp"":::", """
        <pre>
        <code class="lang-csharp">namespace TableSnippets
        </code></pre>

        """)]
    [InlineData(@":::code source=""source.cs"" range=""11 - 33, 40-44"" highlight=""6-7"" language=""azurecli"" interactive=""try-dotnet"":::", """
        <pre>
        ...
        """)]
    [InlineData(@":::code source=""source.cs"" range=""1-2"" language=""azurecli"" interactive=""try-dotnet"":::", """
        <pre>
        ...
        """)]
    [InlineData(@":::code source=""source.cs"" range=""1-2"" interactive=""try-dotnet"":::", """
        <pre>
        ...
        """)]
    [InlineData(@":::code source=""source.cs"" range=""1-2,205-"" highlight=""6-7"" language=""azurecli"" interactive=""try-dotnet"":::", """
        <pre>
        ...
        """)]
    [InlineData(@":::code source=""source.cs"" id=""Snippet_Table_RowGroups_Add"" language=""azurecli"" interactive=""try-dotnet"":::", """
        <pre>
        ...
        """)]
    [InlineData(@":::code source=""source.vb"" id=""snippet2"" interactive=""try-dotnet"":::", """
        <pre>
        ...
        """)]
    [InlineData(@":::code source=""source.vb"" id=""snippet1"" interactive=""try-dotnet"":::", """
        <pre>
    ...
    [InlineData("""
        ...
        :::code language="csharp" source="source3.cs" id="Delegate":::
        """, """
        <p>An example of a delegate would be:</p>
        <pre>
        ...
        """)]
    [InlineData(@":::code source=""source2.cpp"" id=""Snippet1"":::", """
        <pre>
        <code class="lang-cpp">using namespace System;
        ...
        """)]
    [InlineData(@":::code source=""GemFile"" id=""GemFileSnippet"" language=""ruby"":::", """
        <pre>
        ...
        """)]
    [InlineData(@":::code source=""styles.css"" id=""Snippet1"" language=""css"":::", """
        <pre>
