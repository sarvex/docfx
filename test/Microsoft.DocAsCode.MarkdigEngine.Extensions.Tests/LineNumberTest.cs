...
public class LineNumberTest
{
    ...
    public void LineNumberTest_General()
    {
        ...
        // assert
        var expected = """
            <h1 id="a-simple-test-for-line-number" sourceFile="Topic.md" sourceStartLineNumber="2">a simple test for line number</h1>
    ...
    public void LineNumberTest_CodeSnippet()
    {
        ...
        var expected = """
            <pre><code sourceFile="Topic.md" sourceStartLineNumber="1" name="tag-test">line1
            </code></pre>
            """;
    ...
    public void LineNumberTest_Inclusion()
    {
        ...
        var expected = """
            <h1 id="root-content" sourceFile="LineNumber/root.md" sourceStartLineNumber="2">Root content</h1>
